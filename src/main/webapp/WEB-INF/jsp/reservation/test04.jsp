              ...
              <article class="d-flex main-info">
                  ...
                  <div class="d-flex justify-content-center">
                      ...
                      <div class="d-none mt-3 box" id="nonMember">
                          <div class="d-flex justify-content-center">                               
                              <label class="mr-3">이름</label> <input type="text" class="form-control h-100 col-9" id="name" name="name">  
                          </div>
                          <div class="d-flex mt-3 justify-content-center">                        
                              <label class="mr-2">전화번호</label> <input type="text" class="form-control h-100 col-9 mr-4 " id="phoneNumber" name="phoneNumber">
                          </div>                                                                                 
                      </div>
                  </div>
                      <button type="button" id="inquiryBtn" class="btn btn-success text-white float-right mt-3 mr-4">조회하기</button>
                  </div>
  ...
  <script>
      ...
      $(document).ready(function(){
          ...
          $("#inquiryBtn").on("click", function(){
              let checkMember = $("input[name='member']:checked").val();
              let id = $("#id").val();
              let password = $("#password").val();
              let name = $("#name").val();
              let phoneNumber = $("#phoneNumber").val();
              let checkNumber = $("#phoneNumber").val().replace(/-/g, '');
